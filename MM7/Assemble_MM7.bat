...
echo Valid options: "MM7_U" "MM7_E" "MM7_J"
...
if "%Input1%" equ "MM7_U" goto :USA
if "%Input1%" equ "MM7_E" goto :PAL
if "%Input1%" equ "MM7_J" goto :Japan
...
:Japan
set ROMVer=(J)
set ROMNAME=Rockman 7 - Shukumei no Taiketsu
