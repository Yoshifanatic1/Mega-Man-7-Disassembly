; Note: Put your custom routine/data macros, references to them, and defines in this file from within the GAMEX_InsertIntegratedPatches and GAMEX_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro MM7_InsertIntegratedPatches()
...
macro MM7_ApplyPatchesPostAssembly()
